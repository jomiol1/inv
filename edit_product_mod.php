...
<?php
 if(isset($_POST['investors'])){
   ...
   if(empty($errors)){
       ...
       $p_inv_bithday       = remove_junk($db->escape($_POST['inv_birthday']));       
       $p_date_create       = remove_junk($db->escape($_POST['date_create']));
       $p_sex         = (int)$_POST['sex'];
       ...
       */
       ...
       $query  .=" media_id ='{$media_id}', inv_perc_perm='{$p_fijo}', inv_reinvest='{$p_reinvest}', active='{$p_active}', porc_fijo='{$p_fijo_ganan}',inv_birthday='{$p_inv_bithday}',date_create='{$p_date_create}'";
      ...
      if(($result or $result2) or ($db->affected_rows() === 1)){
       ...
       $session->msg("d", $errors);
       redirect('product.php?id='.$product['investor_id'], false);
   }
 }
         ...
         <div class="col-md-12">
           <form method="post" action="edit_product.php?id=<?php echo (int)$product['id'] ?>">
              ...
              <div class="form-group">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                    <label for="qty">Fecha de cumpleaños</label>
                    <div class="input-group">
                      <span class="input-group-addon">
                       <i class="glyphicon glyphicon-shopping-cart"></i>
                      </span>
                      <input  class="form-control" name="inv_bithday" value="<?php echo remove_junk($product['inv_birthday']); ?>">
                      <span class="input-group-addon">
                       %
                      </span>
                   </div>
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input  class="form-control" name="date_create" value="<?php echo remove_junk($product['date_create']); ?>">
                      <span class="input-group-addon">
                       %
                      </span>
                   </div>

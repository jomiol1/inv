...
<?php
  ...
  $products = join_product_table(0,0,0);
?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          ...
          <div class="pull-center">
            <a href="product.php" class="btn btn-primary">Activos</a>
          </div>
          <br>
          <div class="pull-left">
          ...
          <table id="table" class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 10%;"> Dir </th>
            ...
            <tbody>
              ...
              <?php if($product['active']){ echo '<tr>';} else {echo '<tr bgcolor="#FF5C5C">';} ?>
                ...
                <td class="text-center"> <?php echo remove_junk($product['inv_dir']); ?></td>
